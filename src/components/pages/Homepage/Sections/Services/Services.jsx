                ...
                <div className="service-list-line flex gap-10">
                    <MaskedDiv maskType="type-1" size={0.35} className='masked-div '>
                        <div className="service bg-[#DBC7FF] p-5 flex flex-col items-center">
                            ...
                            <p className="mt-3 font-medium">Get a user-friendly website design that creates a strong identity of your brand and meets search engine requirements.</p>
                        </div>
                    </MaskedDiv>
                    <MaskedDiv maskType="type-1" size={0.35} className='masked-div rotate-180'>
                        <div className="service flex flex-col items-center bg-[#FFF8B0] p-5 rotate-180">
                            ...
                            <p className="mt-3 font-medium">With our SEO services, your brand gets to rank higher than your competitors on search engine results pages, drive traffic organically, generate leads, optimized content.</p>
                    ...
                    <MaskedDiv maskType="type-1" size={0.35} className='masked-div '>
                        <div className="service bg-[#acbbff] p-5">
                            ...
                            <p className="mt-3 font-medium">With our vast network and experience of running campaigns, you get new affiliates and new source of revenue.</p>
                        </div>
                    </MaskedDiv>
                </div>
                    ...
                    <MaskedDiv maskType="type-2" size={0.50} className='masked-div2 '>
                        <div className="service bg-[#ffd391] p-5 flex items-center">
                            ...
                            <div className="service-dets">
                                ...
                                <p className="mt-3 font-medium">We make sure that your email marketing campaigns shows quantifiable results and reach target audience effectively.</p>
                            </div>
                        </div>
                    </MaskedDiv>
                    <MaskedDiv maskType="type-2" size={0.50} className='masked-div2 rotate-180'>
                        <div className="service bg-[#ADEBB3] p-5 flex items-center rotate-180">
                            ...
                            <div className="service-dets">
                                ...
                                <p className="mt-3 font-medium">Get personalized strategy that creates a positive hype around your business on the internet.</p>
                            </div>
                        </div>
                    </MaskedDiv>
                </div>
                    ...
                    <MaskedDiv maskType="type-4" size={0.80} className='masked-div3 '>
                        <div className="service bg-[#ffcdc4] p-5 flex items-center">
                            ...
                            <div className="service-dets">
                                ...
                                <p className="mt-3 font-medium">Level up your marketing strategies with our innovation, eye-catching and inventive creations that blend creativity, technology, and data-driven insights to deliver impactful campaigns, strengthen your digital presence, and position your brand as a leader in the marketplace.</p>
                            </div>
                        </div>
                    </MaskedDiv>
                </div>
                    ...
                    <MaskedDiv maskType="type-4" size={0.80} className='masked-div4 rotate-180'>
                        <div className="service bg-[#ffdfc4] p-5 flex items-center rotate-180">
                            ...
                            <div className="service-dets">
                                ...
                                <p className="mt-3 font-medium">We help you grow your digital presence through Social Media Management, Paid Promotions, Page Optimization, Targeted Advertising, Creative Campaigns, Engaging Content, Infographics, and Videos — all tailored to achieve measurable results.</p>
                            </div>
                        </div>
                    </MaskedDiv>
                </div>
