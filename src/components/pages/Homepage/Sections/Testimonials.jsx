    ...
    return (
        <section className='w-full mt-[-5vh] px-10 py-20 rounded-3xl overflow-hidden bg-zinc-200' id='testimonials-section'>
            ...
            <div className="testimonials w-full mt-10">
                ...
                >
                    <SwiperSlide className='bg-[#fff8b08a] backdrop-blur-lg p-10 rounded-3xl text-[1.5rem] leading-tight'>
                    ...
                    <SwiperSlide className='bg-[#ffcac498] backdrop-blur-lg p-10 rounded-3xl text-[1.5rem] leading-tight'>
                    ...
                    <SwiperSlide className='bg-[#dbc7ff94] backdrop-blur-lg p-10 rounded-3xl text-[1.5rem] leading-tight'>
                    ...
                    <SwiperSlide className='bg-[#b6f0ff91] backdrop-blur-lg p-10 rounded-3xl text-[1.5rem] leading-tight'>
                    ...
                    <SwiperSlide className='bg-[#ffabbc8e] backdrop-blur-lg p-10 rounded-3xl text-[1.5rem] leading-tight'>
                    ...
                    <SwiperSlide className='bg-[#adebb398] backdrop-blur-lg p-10 rounded-3xl text-[1.5rem] leading-tight'>
